 ...
 * @added 0.1.0
 */
export class Calculation<A extends CalcOperation = CalcOperation> implements RBType<any> {
    operationType: A;
    data: CalculationData<A>;
    valueConstructor: Function;
    serialize: () => string;

    private constructor(data: any, operationType: A, valueConstructor: Function) {
