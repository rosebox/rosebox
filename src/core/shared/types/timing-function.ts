 ...
 * @added 0.2.1
 */
export class CubicBezierFunction implements RBType<[number, number, number, number]> {
 ...
 * @added 0.2.1
 */
export class StepsFunction implements RBType<[number] | [number, StepPosition]> {
...
type CubicBezierTimingFunction = 'ease' | 'ease-in' | 'ease-out' | 'ease-in-out' | CubicBezierFunction;
...
export const serializeTimingFunctionValue = (value: TimingFunctionValue): string =>
